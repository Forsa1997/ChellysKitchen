# Code Reviewer für Chellys Kitchen
...
- **Evidence**: Where is it in the code?
- **Impact**: What breaks?
...
- If it's a missing architecture piece → escalate to `$solution-architect`
- If it's a security question → escalate to `$security-expert`
