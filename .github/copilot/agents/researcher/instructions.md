...
4. **Compare Options**: Viable paths with trade-offs
...
**Technical**
- Is this feasible with our stack?
...
- See `.agents/shared/coordinator-feature-backlog.md` for sequence
...
3. What's minimal scope to deliver value?
...
4. What are test/migration/rollback implications?
```
...
- Raise unknowns with `@coordinator`
